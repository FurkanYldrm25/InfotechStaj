// Staj.Application/Features/Reviews/Queries/GetMyReceivedReviews/GetMyReceivedReviewsQueryHandler.cs
using MediatR;
...
// Kullanıcının kendisine yapılan değerlendirmeler
public class GetMyReceivedReviewsQueryHandler
    : IRequestHandler<GetMyReceivedReviewsQuery, Result<PagedResult<ReviewDto>>>
{
    private readonly IApplicationDbContext _context;
    private readonly ICurrentUserService _currentUser;

    public GetMyReceivedReviewsQueryHandler(
    ...
    public async Task<Result<PagedResult<ReviewDto>>> Handle(
        GetMyReceivedReviewsQuery request,
        CancellationToken cancellationToken)
    {
        ...
        var query = _context.Reviews
            ...
            .Where(r => r.TargetUserId == userId.Value);
